...
<p align="center">
  ...
  <a href="https://eppetarun.netlify.app" target="_blank"><img src="https://img.shields.io/badge/Live_Portfolio-Visit-%23255E63?style=for-the-badge&logo=About.me&logoColor=white" alt="Portfolio" /></a>
...
| **🌱 Orliv (RAG AI Platform)** | Production-ready Retrieval-Augmented Generation (RAG) agronomic advisory engine using FastAPI, LangChain, Pinecone & Gemini API. | `Python` `FastAPI` `LangChain` `Pinecone` `Gemini` | [💻 Code](https://github.com/eppetarun/orliv) |
...
![](https://github-contributor-stats.vercel.app/api?username=eppetarun&limit=5&theme=dark&combine_all_yearly_contributions=true)
